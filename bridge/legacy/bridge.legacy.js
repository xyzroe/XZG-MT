...
function _interopRequireWildcard(e, t) {
  ...
  return (_interopRequireWildcard = function _interopRequireWildcard(e, t) {
    ...
    for (var _t23 in e)
      "default" !== _t23 &&
        {}.hasOwnProperty.call(e, _t23) &&
        ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, _t23)) && (i.get || i.set)
          ? o(f, _t23, i)
          : (f[_t23] = e[_t23]));
    return f;
  })(e, t);
...
var DEBUG = /^(1|true|yes|on)$/i.test(String(process.env.DEBUG_MODE || ""));
...
try {
  ...
  BonjourCtor =
    (mod === null || mod === void 0 ? void 0 : mod.Bonjour) ||
    (mod === null || mod === void 0 ? void 0 : mod["default"]) ||
    mod ||
    null;
} catch (_) {
  BonjourCtor = null;
...
function _getSerialPort() {
  _getSerialPort = _asyncToGenerator(
          ...
          switch (_context3.n) {
            ...
            case 1:
              if (!serialPortResolvePromise) {
                serialPortResolvePromise = _asyncToGenerator(
                        ...
                        while (1)
                          switch ((_context2.p = _context2.n)) {
                              ...
                              if (extracted && extracted.file) {
                                try {
                                  ...
                                  process.env.DEBUG_MODE &&
                                    console.warn("[serial][pkg] override node-gyp-build failed:", String(e3));
                                }
                              }
                            ...
                            case 3:
                              ...
                              _t6 = _context2.v;
                              process.env.DEBUG_MODE &&
                                console.warn("[serial][pkg] prebuild extraction failed:", String(_t6));
                            case 4:
                              _context2.p = 4;
                              // Prefer CJS require
                              ...
                              if (
                                !(
                                  !_sp ||
                                  (typeof _sp !== "function" &&
                                    typeof _sp.SerialPort !== "function" &&
                                    typeof _sp.list !== "function")
                                )
                              ) {
                                _context2.n = 5;
                                break;
                            ...
                            case 6:
                              ...
                              if (
                                !(
                                  _t7 &&
                                  (_t7.code === "ERR_REQUIRE_ESM" || /Cannot use import statement/.test(String(_t7)))
                                )
                              ) {
                                _context2.n = 10;
                                break;
                            ...
                            case 8:
                              ...
                              return _context2.a(
                                2,
                                (_mod === null || _mod === void 0 ? void 0 : _mod["default"]) || _mod
                              );
                            case 9:
                              _context2.p = 9;
                              _t8 = _context2.v;
                              process.env.DEBUG_MODE && console.warn("[serial] dynamic import failed:", String(_t8));
                            ...
                            case 14:
                              ...
                              Binding =
                                typeof autoDetect === "function"
                                  ? autoDetect()
                                  : (bindingsCpp && bindingsCpp.Binding) || null;
...
function ensureSerialportPrebuildExtractedSync() {
  try {
    ...
    var outDir = path.join(
      os.tmpdir(),
      "ws-tcp-bridge-prebuilds",
      "".concat(plat, "-").concat(arch, "-").concat(process.pid)
    );
    try {
      fs.mkdirSync(outDir, {
        recursive: true,
...
function _ensureSerialportPrebuildExtracted() {
  _ensureSerialportPrebuildExtracted = _asyncToGenerator(
          ...
          while (1)
            switch ((_context4.p = _context4.n)) {
                  ...
                  try {
                    ...
                    if (_entries && _entries.length) {
                      ...
                      if (process.platform === "linux") {
                        ...
                        if (_isMusl && musl) chosenFile = path.join(prebuildDir, musl);
                        else if (!_isMusl && glibc) chosenFile = path.join(prebuildDir, glibc);
                        else chosenFile = path.join(prebuildDir, _entries[0]);
                      } else {
              ...
              case 13:
                ...
                if (DEBUG)
                  console.log("[serial][pkg] prepared prebuilds:", {
                    temp: outFile,
                    pkg: bindingsPkgName,
                  });
...
function _reopenSerialPort() {
  _reopenSerialPort = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee5(path, newBaudRate) {
        ...
        function (_context5) {
          while (1)
            switch ((_context5.p = _context5.n)) {
              ...
              case 6:
                console.log(
                  "[serial] closed serial port for "
                    .concat(path, ", new baudrate ")
                    .concat(newBaudRate, " will be used for new connections")
                );
                  ...
                  try {
                    ...
                    if (_origWriteHead) {
                      res.writeHead = function () {
                        ...
                        try {
                          for (
                            var _i3 = 0, _Object$keys2 = Object.keys(_corsHeaders);
...
wss.on("connection", function (ws, req) {
  try {
    ...
    ws === null ||
      ws === void 0 ||
      (_ws$_socket = ws._socket) === null ||
      _ws$_socket === void 0 ||
      (_ws$_socket$setNoDela = _ws$_socket.setNoDelay) === null ||
      _ws$_socket$setNoDela === void 0 ||
      _ws$_socket$setNoDela.call(_ws$_socket, true);
    ws === null ||
      ws === void 0 ||
      (_ws$_socket2 = ws._socket) === null ||
      _ws$_socket2 === void 0 ||
      (_ws$_socket2$setKeepA = _ws$_socket2.setKeepAlive) === null ||
      _ws$_socket2$setKeepA === void 0 ||
      _ws$_socket2$setKeepA.call(_ws$_socket2, true, 5000);
  } catch (_unused25) {}
...
server.listen(WS_PORT, "0.0.0.0", function () {
  ...
  var wsVersion =
    tryReadPkgVersion("ws") ||
    (WebSocket && (WebSocket === null || WebSocket === void 0 ? void 0 : WebSocket.version)) ||
    "unknown";
  var bonjourVersion =
...
function _scanMdns() {
  _scanMdns = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee6(typeList, timeoutMs) {
                ...
                var onUp = function onUp(svc, base) {
                  try {
                    ...
                    var ip =
                      (svc === null ||
                      svc === void 0 ||
                      (_svc$addresses = svc.addresses) === null ||
                      _svc$addresses === void 0
                        ? void 0
                        : _svc$addresses[0]) || (svc === null || svc === void 0 ? void 0 : svc.host);
                    var board =
                      (svc === null || svc === void 0 || (_svc$txt = svc.txt) === null || _svc$txt === void 0
                        ? void 0
                        : _svc$txt.board) || "";
                    var serialNum =
                      (svc === null || svc === void 0 || (_svc$txt2 = svc.txt) === null || _svc$txt2 === void 0
                        ? void 0
                        : _svc$txt2.serial_number) || "";
                    console.log(
                      "[mdns] found: "
                        .concat(base === null || base === void 0 ? void 0 : base.type, " on ")
                        .concat(ip, ":")
                        .concat(svc === null || svc === void 0 ? void 0 : svc.port, " (")
                        .concat(board, ", ")
                        .concat(serialNum, ")")
                    );
...
function _closeSerialTcpServer() {
  _closeSerialTcpServer = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee7(path) {
...
function _scanAndSyncSerialPorts() {
  _scanAndSyncSerialPorts = _asyncToGenerator(
...
function _startSerialMonitor() {
  _startSerialMonitor = _asyncToGenerator(
...
function _closeAllSerialServers() {
  _closeAllSerialServers = _asyncToGenerator(
...
function _gracefulShutdown() {
  _gracefulShutdown = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee1(code) {
      var _t22;
      return _regenerator().w(
        function (_context10) {
          while (1)
...
function _listLocalSerialAsServices() {
  _listLocalSerialAsServices = _asyncToGenerator(
...
function _ensureSerialTcpServer() {
  _ensureSerialTcpServer = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee11(path, baudRate) {
        ...
        while (1)
          switch (_context12.n) {
            ...
            case 2:
              ...
              effectiveBaudRate =
                (currentState === null || currentState === void 0 ? void 0 : currentState.baudRate) ||
                baudRate ||
                460800;
              ...
              server.on("connection", function (socket) {
                ...
                var cleanup = function cleanup(reason) {
                  ...
                  if (refCount > 1) {
                    ...
                    console.log(
                      "[serial] connection closed for",
                      path,
                      "(reason: ".concat(reason, "), refs remaining:"),
                      refCount - 1
                    );
                  } else {
