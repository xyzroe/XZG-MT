              ...
              return _regenerator().w(function (_context2) {
                while (1) switch (_context2.p = _context2.n) {
                  ...
                  case 3:
                    _context2.p = 3;
                    _t6 = _context2.v;
                    process.env.DEBUG_MODE && console.warn("[serial][pkg] prebuild extraction failed:", String(_t6));
                  case 4:
                    _context2.p = 4;
                    // Prefer CJS require
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 1:
          ...
          if (DEBUG) console.log("[serial][pkg] unsupported platform/arch for prebuilds:", {
            plat: plat,
            arch: arch
          });
...
server.listen(WS_PORT, "0.0.0.0", function () {
  console.log("[XZG-MT] access UI at http://".concat(getAdvertiseHost(), ":").concat(WS_PORT));
